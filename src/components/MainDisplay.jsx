...
export function MainDisplay(props) {
	return (
		<div className='mt-6 px-4 md:col-span-2'>
			<div className='bg-no-repeat bg-cover bg-[url(../assets/images/bg-today-small.svg)] md:bg-[url(../assets/images/bg-today-large.svg)] h-70 rounded-lg md:h-64 md:flex md:flex-row md:items-center md:justify-center md:text-center md:justify-between'>
				<div>
